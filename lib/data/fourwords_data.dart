...
List<Words> wordsList4 = [
  ...
  Words(
      ...
      quest: 'structure'),
  Words(
      front: "He is struggling to find a job in the current economic climate .",
  ...
  Words(
      ...
      quest: 'tunnel'),
  Words(
      front: "Ultimately, the goal is to create a better future for everyone .",
      back: "Sonuç olarak, amaç herkes için daha iyi bir gelecek yaratmaktır .",
      list: 'B2',
      answer: 'sonunda',
      quest: 'ultimately'),
  Words(
